      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className={`mt-16 text-center ${hasMore ? '' : 'hidden'}`}>
          <button
            ...
            className="inline-flex h-14 items-center justify-center bg-transparent border-2 border-primary text-primary px-4 sm:px-8 rounded-md font-bold text-center whitespace-nowrap hover:bg-primary hover:text-primary-foreground transition-colors"
          >
